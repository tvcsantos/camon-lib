...
public final class BibtexMultipleValues extends BibtexAbstractValue {
    ...
    private final ArrayList<BibtexAbstractValue> values = new ArrayList<BibtexAbstractValue>(3);
    ...
    public void printBibtex(PrintWriter writer) {
        ...
        for (Iterator<BibtexAbstractValue> it = this.values.iterator(); it.hasNext();) {
     ...
     */
    public List<BibtexAbstractValue> getValues() {
