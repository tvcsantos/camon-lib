...
public final class BibtexEntry extends BibtexAbstractEntry {
    ...
    private Map<String, BibtexAbstractValue> fields = new HashMap<String, BibtexAbstractValue>();
     ...
     */
    public List<BibtexAbstractValue> getFieldValuesAsList(String fieldName){
        
        assert fieldName!=null: "fieldName parameter may not be null.";
        
        BibtexAbstractValue value = this.fields.get(fieldName);
    ...
    public void printBibtex(PrintWriter writer) {
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            if (value instanceof BibtexMultipleValues) {
                ...
                for (Iterator<BibtexAbstractValue> valuesIt = values.getValues().iterator(); valuesIt.hasNext();) {
