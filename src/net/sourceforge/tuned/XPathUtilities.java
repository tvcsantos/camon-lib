...
public final class XPathUtilities {
    ...
    public static List<Node> selectNodes(String xpath, Object node) {
        try {
            return new NodeListDecorator((NodeList) getXPath(xpath).
    ...
    public static String selectString(String xpath, Object node) {
        try {
            return ((String) getXPath(xpath).evaluate(node,
     ...
     * @return text content of the child node or null if no child
    ...
    /**
     * Get text content of the first child node matching the given node name. 
     * Use this method instead of {@link #selectString(String, Object)}
     * whenever xpath support is not required,
